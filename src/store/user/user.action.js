...
// SIGN_IN__SUCCESS: 'user/SIGN_IN__SUCCESS',
// SIGN_IN__FAILURE: 'user/SIGN_IN__FAILURE',
...
export const signInFailed = (error) => createAction(USER_ACTION_TYPES.SIGN_IN__FAILED, error);
